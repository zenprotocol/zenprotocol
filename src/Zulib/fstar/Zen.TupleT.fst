...
val mapJoin(#a #b:Type)(#n:nat): (a -> cost b n) -> a**a -> cost (b**b) (n*2)
let mapJoin #_ #_ #_ mf = T.map mf >> join

val mapJoin3(#a #b:Type)(#n:nat): (a -> cost b n) -> a**a**a -> cost (b**b**b) (n*3)
let mapJoin3 #_ #_ #_ mf = T.map3 mf >> join3

val mapJoin4(#a #b:Type)(#n:nat): (a -> cost b n) -> a**a**a**a -> cost (b**b**b**b) (n*4)
